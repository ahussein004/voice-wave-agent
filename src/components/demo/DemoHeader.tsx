...
const DemoHeader = () => {
  return (
    ...
    >
      ...
      <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-indigo-400 via-violet-400 to-purple-400 bg-clip-text text-transparent leading-tight">
      ...
      <motion.div 
        ...
        className="inline-block px-5 py-3 rounded-lg bg-gray-800/50 backdrop-blur-sm border border-indigo-500/30 text-base font-medium shadow-lg"
      >
        <span className="block">Select an industry below to explore our AI voice solutions</span>
        <span className="text-sm text-gray-400 mt-1 block">Complete with smart features like emotion detection and SMS notifications</span>
      </motion.div>
    </motion.div>
  );
};
