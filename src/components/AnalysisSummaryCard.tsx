...
const AnalysisSummaryCard = () => {
  ...
  return (
    <div className="bg-white rounded-xl border border-sky-200 shadow-lg p-6 flex flex-col h-full">
      {/* Header section */}
      ...
      <div className="space-y-4 flex-grow">
        ...
        <div className="p-4 bg-gray-50 rounded-lg border border-gray-100">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h4 className="text-sm font-medium text-gray-700">Urgency Assessment</h4>
          </div>
          <div className="space-y-3">
            <div>
              <div className="flex items-center justify-between mb-1">
                <span className="text-xs text-gray-600">Severity</span>
                <span className="text-xs font-medium text-amber-600">Medium (65%)</span>
              </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <span className="text-xs font-medium text-red-600">High (85%)</span>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-2">
        ...
        <div className="p-4 bg-gray-50 rounded-lg border border-gray-100">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h4 className="text-sm font-medium text-gray-700">Clinical Actions</h4>
          </div>
          <div className="space-y-2.5">
            <div className="flex items-start gap-3">
              <div className="w-4 h-4 mt-0.5 rounded-full bg-sky-500 flex items-center justify-center flex-shrink-0">
                <motion.div
              ...
              <div>
                <p className="text-xs font-medium text-gray-700">Schedule urgent appointment</p>
                <p className="text-xs text-gray-500">Same-day appointment with Dr. Smith</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-xs font-medium text-gray-700">Send pre-appointment instructions</p>
                <p className="text-xs text-gray-500">Fasting requirements and ID/insurance reminder</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-4 h-4 mt-0.5 rounded-full bg-green-500 flex items-center justify-center flex-shrink-0">
                <motion.div
                  animate={{ opacity: [0.5, 1, 0.5] }}
              ...
              <div>
                <p className="text-xs font-medium text-gray-700">Create new patient record</p>
                <p className="text-xs text-gray-500">Update EHR with preliminary symptoms</p>
              </div>
            </div>
          </div>
        </div>
