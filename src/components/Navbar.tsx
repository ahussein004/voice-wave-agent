    ...
    <div className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${isScrolled ? "bg-white shadow-md" : "bg-white"}`}>
      <div className="container mx-auto flex items-center justify-between py-4 px-4 md:px-6">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          {navLinks.map(link => (
            <a 
              key={link.name} 
              href={link.href} 
              className="text-base font-semibold text-voice-purple hover:text-voice-purple-light transition-colors focus-visible-ring"
        ...
        <div className="flex items-center space-x-4">
          ...
          <button 
            className="md:hidden text-voice-purple hover:text-voice-purple-light transition-colors p-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-voice-purple rounded-md" 
