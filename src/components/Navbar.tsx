...
const Navbar = () => {
  return (
    <div className="fixed top-0 left-0 w-full z-50 bg-voice-dark/80 backdrop-blur-md border-b border-voice-purple/20">
      <div className="container mx-auto flex items-center justify-between py-4">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <a href="#testimonials" className="text-sm text-voice-cream/70 hover:text-voice-purple-light transition-colors">Testimonials</a>
        </nav>
        
        <div className="flex items-center space-x-4">
          <Button variant="ghost" className="text-sm hidden md:flex hover:text-voice-purple-light hover:bg-transparent">Log in</Button>
