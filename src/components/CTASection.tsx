...
const CTASection = () => {
  return (
    <section className="py-32 bg-gradient-to-br from-gray-900 to-voice-dark border-t border-indigo-500/10" id="cta-section">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <motion.h2 
            className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-indigo-400 via-violet-400 to-purple-400 bg-clip-text text-transparent"
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-stretch">
          ...
          <motion.div 
            className="w-full lg:w-3/5 bg-gradient-to-br from-gray-900/50 to-gray-800/50 p-4 sm:p-6 rounded-xl border border-indigo-500/20 backdrop-blur-sm"
